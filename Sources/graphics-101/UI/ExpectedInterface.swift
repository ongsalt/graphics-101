...
func Text(_ string: String) -> some UI {
    UIImpl()
}
...
// func `_-SomePrefix🔥🔥🔥🔥🔥::Counter`(text: ReadOnlySignal<String>, count: Signal<Int>) {}
...
// no auto derived
func Counter(text: String, reactiveText: String) -> some UI {
...
func Counter(text: String, reactiveText: Signal<String>) -> some UI {
